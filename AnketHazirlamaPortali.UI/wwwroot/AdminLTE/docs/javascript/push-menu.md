...
```html
<button class="btn btn-secondary" data-widget="pushmenu">Toggle Sidebar</button>
```
...
> ```html
> <button class="btn btn-secondary" data-widget="pushmenu" data-auto-collapse-size="768">Toggle Sidebar</button>
> ```
{: .quote-info}
