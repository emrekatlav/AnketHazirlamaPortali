...
var LinkDialog = /*#__PURE__*/function () {
  ...
  LinkDialog_createClass(LinkDialog, [{
    ...
    value: function initialize() {
      ...
      var buttonClass = 'btn btn-secondary note-btn note-btn-secondary note-link-btn';
...
var ImageDialog = /*#__PURE__*/function () {
  ...
  ImageDialog_createClass(ImageDialog, [{
    ...
    value: function initialize() {
      ...
      var buttonClass = 'btn btn-secondary note-btn note-btn-secondary note-image-btn';
...
var VideoDialog = /*#__PURE__*/function () {
  ...
  VideoDialog_createClass(VideoDialog, [{
    ...
    value: function initialize() {
      ...
      var buttonClass = 'btn btn-secondary note-btn note-btn-secondary note-video-btn';
...
var videoDialog = function videoDialog(opt) {
  ...
  var footer = ['<button type="button" href="#" class="note-btn note-btn-secondary note-video-btn disabled" disabled>', opt.lang.video.insert, '</button>'].join('');
  return dialog({
...
var imageDialog = function imageDialog(opt) {
  ...
  var footer = ['<button href="#" type="button" class="note-btn note-btn-secondary note-btn-large note-image-btn disabled" disabled>', opt.lang.image.insert, '</button>'].join('');
  return dialog({
...
var linkDialog = function linkDialog(opt) {
  ...
  var footer = ['<button href="#" type="button" class="note-btn note-btn-secondary note-link-btn disabled" disabled>', opt.lang.link.insert, '</button>'].join('');
  return dialog({
    className: 'link-dialog',
